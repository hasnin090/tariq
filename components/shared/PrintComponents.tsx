  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={title} size="xl">
      <div className="flex flex-col h-[70vh]">
        {/* Preview Frame */}
        <div className="flex-1 bg-gray-100 dark:bg-slate-900 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-700">
          <iframe
            srcDoc={htmlContent}
...
export const PrintContractButton: React.FC<PrintContractButtonProps> = ({
  ...
  const htmlContent = useMemo(() => generateContractHTML(booking, company), [booking, company]);
