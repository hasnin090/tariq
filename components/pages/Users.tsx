...
const RoleBadge: React.FC<{ role: User['role'] }> = ({ role }) => {
    const colors = {
        ...
        Accounting: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-500/20 dark:text-emerald-300',
    };
...
const PermissionBadge: React.FC<{ type: 'view' | 'edit' | 'delete' }> = ({ type }) => {
    const styles = {
        view: { text: 'عرض', color: 'bg-blue-100 text-blue-800 dark:bg-blue-500/20 dark:text-blue-300' },
